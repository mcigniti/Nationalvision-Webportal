/* 
**********************************************************
 * Description : TC_011_StoreNumberSearch_AmericaBest.cs is a test case which opens 
...
namespace NationalVision.Automation.Tests.Cases.StoreNumberSearch.TC_011_StoreNumberSearch_AmericaBest
{
    class TC_011_StoreNumberSearch_AmericaBest : BaseCase
    {
        List<string> menulist = CommonPage.GetColoumnValues("TC_011_StoreNumberSearch_AmericaBest", "Menu");
        List<string> submenulist = CommonPage.GetColoumnValues("TC_011_StoreNumberSearch_AmericaBest", "SubMenu");
        List<string> externalapplicationmenulist = CommonPage.GetColoumnValues("TC_011_StoreNumberSearch_AmericaBest", "ExternalApplicationMenu");
        List<string> externalapplicationsubmenulist = CommonPage.GetColoumnValues("TC_011_StoreNumberSearch_AmericaBest", "ExternalApplicationSubMenu");
