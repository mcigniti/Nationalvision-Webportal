/* Description : TC_021_ClickAddNewButton_AmericaBest.cs is a test case which opens 
...
namespace NationalVision.Automation.Tests.Cases.ClickAddNewButton.TC_021_ClickAddNewButton_AmericaBest
{
    class TC_021_ClickAddNewButton_AmericaBest : BaseCase
    {
        List<string> menulist = CommonPage.GetColoumnValues("TC_021_ClickAddNewButton_AmericaBest", "Menu");
        List<string> submenulist = CommonPage.GetColoumnValues("TC_021_ClickAddNewButton_AmericaBest", "SubMenu");
        List<string> externalapplicationmenulist = CommonPage.GetColoumnValues("TC_021_ClickAddNewButton_AmericaBest", "ExternalApplicationMenu");
        List<string> externalapplicationsubmenulist = CommonPage.GetColoumnValues("TC_021_ClickAddNewButton_AmericaBest", "ExternalApplicationSubMenu");
