/* **********************************************************
 * Description : TC_014_FredMeyerApplicationOrVistaApplication.cs is a test case which opens 
...
namespace NationalVision.Automation.Tests.Cases.StoreNumberSearch.TC_014_FredMeyerApplicationOrVistaApplication
{
    class TC_014_FredMeyerApplicationOrVistaApplication : BaseCase
    {
        List<string> menulist = CommonPage.GetColoumnValues("TC_014_FredMeyerApplicationOrVistaApplication", "Menu");
        List<string> submenulist = CommonPage.GetColoumnValues("TC_014_FredMeyerApplicationOrVistaApplication", "SubMenu");
        List<string> externalapplicationmenulist = CommonPage.GetColoumnValues("TC_014_FredMeyerApplicationOrVistaApplication", "ExternalApplicationMenu");
        List<string> externalapplicationsubmenulist = CommonPage.GetColoumnValues("TC_014_FredMeyerApplicationOrVistaApplication", "ExternalApplicationSubMenu");
