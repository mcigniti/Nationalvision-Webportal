/* **********************************************************
 * Description : TC_008_LABApplication.cs is a test case which opens 
...
namespace NationalVision.Automation.Tests.Cases.Phase1.TC_008_LABApplication
{
    class TC_008_LABApplication : BaseCase
    {
        ...
        protected override void ExecuteTestCase()
        {
            ...
            {
                Step = "Click the links under "+ "<b>" + menu + "</b>" + " menu";
