...
namespace NationalVision.Automation.Pages
{
    public class CommonPage : BaseCase
    {
        ...
        /// <summary>
        /// ClickSubMenuLink method clicks on sub menu
        /// </summary>
        /// <param name="driver"></param>
        /// <param name="reporter"></param>
        ...
        /// <summary>
        /// Login method logs into the given web site
        /// </summary>
        /// <param name="driver"></param>
        /// <param name="reporter"></param>
        ...
        /// <summary>
        /// takeScreenshot method captures the screen at any perticular place and stores it in resutls folder
        /// </summary>
        /// <param name="driver"></param>
        ...
        /// <summary>
        /// TakeScreenShotAndAttachToReport method captures the screen at any perticular place and stores it in resutls folder
        /// </summary>
        /// <param name="driver"></param>
        /// <param name="link"></param>
        /// <param name="resultsPath"></param>
        ...
        /// <summary>
        /// CloseBrowserNewTab method Closes opened new tab
        /// </summary>
        /// <param name="driver"></param>
        ...
        /// <summary>
        /// GetMenuNames returns menu text of menu link
        /// </summary>
        /// <param name="driver"></param>
        /// <param name="reporter"></param>
        ...
        /// <summary>
        /// ClickAllSubMenusInEachMenu method clicks the links in each menu of WebPortal
        /// </summary>
        /// <param name="driver"></param>
        /// <param name="reporter"></param>
        ...
        /// <summary>
        /// GetColoumnValues method gets the all menu values mentioned in the testdata csv
        /// </summary>
        /// <param name="TestCaseName"></param>
        /// <param name="valueundermenucoloumn"></param>
        /// <returns="menulist"></returns>
        ...
        /// <summary>
        /// ClickExternalApplicationMenus method clicks the content links in the WebPortal
        /// </summary>
        /// <param name="driver"></param>
        /// <param name="reporter"></param>
        /// <param name="resultsPath"></param>
