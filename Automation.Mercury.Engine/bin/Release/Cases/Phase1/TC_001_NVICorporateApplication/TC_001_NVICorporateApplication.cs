        /* Description : TC_001_NVICorporateApplication.cs is a test case which opens 
...
namespace NationalVision.Automation.Tests.Cases.Phase1.TC_001_NVICorporateApplication
{
    class TC_001_NVICorporateApplication : BaseCase
    {
