/* **********************************************************
 * Description : TC_015_StoreNumberSearch_VisionCenter.cs is a test case which opens 
...
namespace NationalVision.Automation.Tests.Cases.StoreNumberSearch.TC_015_StoreNumberSearch_VisionCenter
{
    class TC_015_StoreNumberSearch_VisionCenter : BaseCase
    {
        List<string> menulist = CommonPage.GetColoumnValues("TC_015_StoreNumberSearch_VisionCenter", "Menu");
        List<string> submenulist = CommonPage.GetColoumnValues("TC_015_StoreNumberSearch_VisionCenter", "SubMenu");
        List<string> externalapplicationmenulist = CommonPage.GetColoumnValues("TC_015_StoreNumberSearch_VisionCenter", "ExternalApplicationMenu");
        List<string> externalapplicationsubmenulist = CommonPage.GetColoumnValues("TC_015_StoreNumberSearch_VisionCenter", "ExternalApplicationSubMenu");
