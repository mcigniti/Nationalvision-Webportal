/* **********************************************************
 * Description : TC_016_StoreNumberSearch_LABPortal.cs is a test case which opens 
...
namespace NationalVision.Automation.Tests.Cases.StoreNumberSearch.TC_016_StoreNumberSearch_LABPortal
{
    class TC_016_StoreNumberSearch_LABPortal : BaseCase
    {
        List<string> menulist = CommonPage.GetColoumnValues("TC_016_StoreNumberSearch_LABPortal", "Menu");
        List<string> submenulist = CommonPage.GetColoumnValues("TC_016_StoreNumberSearch_LABPortal", "SubMenu");
        List<string> externalapplicationmenulist = CommonPage.GetColoumnValues("TC_016_StoreNumberSearch_LABPortal", "ExternalApplicationMenu");
        List<string> externalapplicationsubmenulist = CommonPage.GetColoumnValues("TC_016_StoreNumberSearch_LABPortal", "ExternalApplicationSubMenu");
