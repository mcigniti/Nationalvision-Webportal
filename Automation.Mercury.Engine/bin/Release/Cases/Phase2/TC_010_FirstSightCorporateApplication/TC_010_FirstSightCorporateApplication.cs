/* **********************************************************
 * Description : TC_010_FirstSightCorporateApplication.cs is a test case which opens 
...
namespace NationalVision.Automation.Tests.Cases.Phase2.TC_010_FirstSightCorporateApplication
{
    class TC_010_FirstSightCorporateApplication : BaseCase
    {
        List<string> menulist = CommonPage.GetColoumnValues("TC_010_FirstSightCorporateApplication", "Menu");
        List<string> submenulist = CommonPage.GetColoumnValues("TC_010_FirstSightCorporateApplication", "SubMenu");
        List<string> externalapplicationmenulist = CommonPage.GetColoumnValues("TC_010_FirstSightCorporateApplication", "ExternalApplicationMenu");
        List<string> externalapplicationsubmenulist = CommonPage.GetColoumnValues("TC_010_FirstSightCorporateApplication", "ExternalApplicationSubMenu");
