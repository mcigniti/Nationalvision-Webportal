/* Description : TC_023_FirstSight_CostCenterNoSearch.cs is a test case  which opens the menu 
...
namespace NationalVision.Automation.Tests.Cases.StoreNumberSearch.TC_023_FirstSight_CostCenterNoSearch
{
    class TC_023_FirstSight_CostCenterNoSearch : BaseCase
    {
        List<string> menulist = CommonPage.GetColoumnValues("TC_023_FirstSight_CostCenterNoSearch", "Menu");
        List<string> submenulist = CommonPage.GetColoumnValues("TC_023_FirstSight_CostCenterNoSearch", "SubMenu");
        List<string> externalapplicationmenulist = CommonPage.GetColoumnValues("TC_023_FirstSight_CostCenterNoSearch", "ExternalApplicationMenu");
        List<string> externalapplicationsubmenulist = CommonPage.GetColoumnValues("TC_023_FirstSight_CostCenterNoSearch", "ExternalApplicationSubMenu");
