/* 
**********************************************************
 * Description : TC_013_StoreNumberSearch_OpticalCenter.cs is a test case which opens 
...
namespace NationalVision.Automation.Tests.Cases.StoreNumberSearch.TC_013_StoreNumberSearch_OpticalCenter
{
    class TC_013_StoreNumberSearch_OpticalCenter : BaseCase
    {
        List<string> menulist = CommonPage.GetColoumnValues("TC_013_StoreNumberSearch_OpticalCenter", "Menu");
        List<string> submenulist = CommonPage.GetColoumnValues("TC_013_StoreNumberSearch_OpticalCenter", "SubMenu");
        List<string> externalapplicationmenulist = CommonPage.GetColoumnValues("TC_013_StoreNumberSearch_OpticalCenter", "ExternalApplicationMenu");
        List<string> externalapplicationsubmenulist = CommonPage.GetColoumnValues("TC_013_StoreNumberSearch_OpticalCenter", "ExternalApplicationSubMenu");
