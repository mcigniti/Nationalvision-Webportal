/* Description : TC_020_ClickAddNewButton_VisionCenter.cs is a test case which opens 
...
namespace NationalVision.Automation.Tests.Cases.ClickAddNewButton.TC_020_ClickAddNewButton_VisionCenter
{
    class TC_020_ClickAddNewButton_VisionCenter : BaseCase
    {
        List<string> menulist = CommonPage.GetColoumnValues("TC_020_ClickAddNewButton_VisionCenter", "Menu");
        List<string> submenulist = CommonPage.GetColoumnValues("TC_020_ClickAddNewButton_VisionCenter", "SubMenu");
        List<string> externalapplicationmenulist = CommonPage.GetColoumnValues("TC_020_ClickAddNewButton_VisionCenter", "ExternalApplicationMenu");
        List<string> externalapplicationsubmenulist = CommonPage.GetColoumnValues("TC_020_ClickAddNewButton_VisionCenter", "ExternalApplicationSubMenu");
