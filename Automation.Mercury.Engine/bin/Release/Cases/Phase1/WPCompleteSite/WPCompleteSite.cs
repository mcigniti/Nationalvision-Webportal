/* **********************************************************
 * Description : WPCompleteSite.cs is a test case which opens 
...
namespace NationalVision.Automation.Tests.Cases.Phase1.WPCompleteSite
{
    class WPCompleteSite : BaseCase
    {
