/* 
**********************************************************
 * Description : TC_013_StoreNumberSearch__OpticalCenter.cs is a test case which opens 
...
namespace NationalVision.Automation.Tests.Cases.StoreNumberSearch.TC_013_OpticalCenterOrMilitaryApplication
{
    class TC_013_OpticalCenterOrMilitaryApplication : BaseCase
    {
        List<string> menulist = CommonPage.GetColoumnValues("TC_013_OpticalCenterOrMilitaryApplication", "Menu");
        List<string> submenulist = CommonPage.GetColoumnValues("TC_013_OpticalCenterOrMilitaryApplication", "SubMenu");
        List<string> externalapplicationmenulist = CommonPage.GetColoumnValues("TC_013_OpticalCenterOrMilitaryApplication", "ExternalApplicationMenu");
        List<string> externalapplicationsubmenulist = CommonPage.GetColoumnValues("TC_013_OpticalCenterOrMilitaryApplication", "ExternalApplicationSubMenu");
