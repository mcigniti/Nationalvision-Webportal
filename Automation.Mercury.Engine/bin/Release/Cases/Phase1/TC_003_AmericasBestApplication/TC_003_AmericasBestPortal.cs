/* **********************************************************
 * Description : TC_003_AmericasBestApplication.cs is a test case which opens 
...
namespace NationalVision.Automation.Tests.Cases.Phase1.TC_003_AmericasBestApplication
{
    class TC_003_AmericasBestApplication : BaseCase
    {
        ...
        protected override void ExecuteTestCase()
        {
            ...
            Step = "Select "+"<b>" +TestData["APPLICATIONNAME"] + "</b>" + " link from the navigation menu";
            ...
            Step = "Number of menu items in  " +"<b>"+ TestData["APPLICATIONNAME"] +"</b>"+ "menu is:"+"<b>" +menuCount+ "</b>";
