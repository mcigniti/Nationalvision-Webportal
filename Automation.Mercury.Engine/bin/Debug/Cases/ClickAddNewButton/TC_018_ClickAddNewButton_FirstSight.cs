/* Description : TC_018_ClickAddNewButton_FirstSight.cs is a test case which opens 
...
namespace NationalVision.Automation.Tests.Cases.ClickAddNewButton.TC_018_ClickAddNewButton_FirstSight
{
    class TC_018_ClickAddNewButton_FirstSight : BaseCase
    {
        List<string> menulist = CommonPage.GetColoumnValues("TC_018_ClickAddNewButton_FirstSight", "Menu");
        List<string> submenulist = CommonPage.GetColoumnValues("TC_018_ClickAddNewButton_FirstSight", "SubMenu");
        List<string> externalapplicationmenulist = CommonPage.GetColoumnValues("TC_018_ClickAddNewButton_FirstSight", "ExternalApplicationMenu");
        List<string> externalapplicationsubmenulist = CommonPage.GetColoumnValues("TC_018_ClickAddNewButton_FirstSight", "ExternalApplicationSubMenu");
