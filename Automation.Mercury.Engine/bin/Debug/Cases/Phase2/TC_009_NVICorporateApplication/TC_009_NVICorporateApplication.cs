/* Description : TC_009_SIM_ExternalApplication.cs is a test case which opens 
...
namespace NationalVision.Automation.Tests.Cases.Phase2.TC_009_SIM_ExternalApplication
{
    class TC_009_NVICorporateApplication : BaseCase
    {
        List<string> menulist = CommonPage.GetColoumnValues("TC_009_NVICorporateApplication", "Menu");
        List<string> submenulist = CommonPage.GetColoumnValues("TC_009_NVICorporateApplication", "SubMenu");
        List<string> externalapplicationmenulist = CommonPage.GetColoumnValues("TC_009_NVICorporateApplication", "ExternalApplicationMenu");
        List<string> externalapplicationsubmenulist = CommonPage.GetColoumnValues("TC_009_NVICorporateApplication", "ExternalApplicationSubMenu");
