/* **********************************************************
 * Description : TC_014_StoreNumberSearch_VistaApplication.cs is a test case which opens 
...
namespace NationalVision.Automation.Tests.Cases.StoreNumberSearch.TC_014_StoreNumberSearch_VistaApplication
{
    class TC_014_StoreNumberSearch_VistaApplication : BaseCase
    {
        List<string> menulist = CommonPage.GetColoumnValues("TC_014_StoreNumberSearch_VistaApplication", "Menu");
        List<string> submenulist = CommonPage.GetColoumnValues("TC_014_StoreNumberSearch_VistaApplication", "SubMenu");
        List<string> externalapplicationmenulist = CommonPage.GetColoumnValues("TC_014_StoreNumberSearch_VistaApplication", "ExternalApplicationMenu");
        List<string> externalapplicationsubmenulist = CommonPage.GetColoumnValues("TC_014_StoreNumberSearch_VistaApplication", "ExternalApplicationSubMenu");
