/* Description : TC_020_ClickAddNewButton_Walmart.cs is a test case which opens 
...
namespace NationalVision.Automation.Tests.Cases.ClickAddNewButton.TC_020_ClickAddNewButton_Walmart
{
    class TC_020_ClickAddNewButton_Walmart : BaseCase
    {
        List<string> menulist = CommonPage.GetColoumnValues("TC_020_ClickAddNewButton_Walmart", "Menu");
        List<string> submenulist = CommonPage.GetColoumnValues("TC_020_ClickAddNewButton_Walmart", "SubMenu");
        List<string> externalapplicationmenulist = CommonPage.GetColoumnValues("TC_020_ClickAddNewButton_Walmart", "ExternalApplicationMenu");
        List<string> externalapplicationsubmenulist = CommonPage.GetColoumnValues("TC_020_ClickAddNewButton_Walmart", "ExternalApplicationSubMenu");
